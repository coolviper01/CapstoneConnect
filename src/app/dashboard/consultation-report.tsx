...
export const ConsultationReport = React.forwardRef<HTMLDivElement, ConsultationReportProps>(({ consultation, advisor }, ref) => {
  return (
    <div ref={ref} className="p-8 bg-white text-black font-serif">
